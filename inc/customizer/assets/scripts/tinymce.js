...
window.tvlrAdditionalTinyMCE = window.tvlrAdditionalTinyMCE || {};
( function ( window, document, $, app ) {
	 ...
	 */
	app.l10n = window.tvlrAdditionalTinyMCE || {};
	...
	app.MeetsRequirements = function () {
		return $( '.tvlr-customize-text-editor' ).length;
	};
	...
	return app;
} )( window, document, jQuery, window.tvlrAdditionalTinyMCE );
