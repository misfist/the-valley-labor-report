...
final class Text_Editor_Custom_Control extends \WP_Customize_Control {
	...
	public function render_content() {
		...
		<div class="tvlr-customize-text-editor">
			<?php
	...
	protected function enqueue_scripts() {
		...
		wp_enqueue_script( 'tvlr-customize-editor-js', get_template_directory_uri() . '/inc/customizer/assets/scripts/tinymce.js', array( 'jquery' ), '1.0.0', true );
	}
	...
	protected function add_footer_scripts() {
		do_action( 'tvlr_admin_print_footer_scripts' );
	}
}
