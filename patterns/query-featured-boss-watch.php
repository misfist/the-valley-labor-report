...
<!-- wp:query {"queryId":6,"query":{"perPage":"1","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"category":[<?php echo intval( $id ); ?>]}},"displayLayout":{"type":"div"},"layout":{"type":"default"},"enhancedPagination":true,"tagName":"section"} -->
